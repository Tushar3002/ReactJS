    ...
    <div className="max-w-md mx-auto mt-10 p-4 border rounded shadow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          <label>City:</label>
          <input
            className={`input-box ${errors.city ? "border-red-500" : ""}`}
            {...register("city")}
          />
        ...
        <div>
          ...
          <input
            type="password"
            className={`input-box ${errors.password ? "border-red-500" : ""}`}
            {...register("password")}
          />
        ...
        <div>
          ...
          <input
            type="password"
            className={`input-box ${errors.confirmPassword ? "border-red-500" : ""}`}
